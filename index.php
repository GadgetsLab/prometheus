...
<body>
	...
	<div class="nav-bar-container">
		<video id="background-video" loop="loop" autoplay="autoplay">
			<source src="videos/background2.mp4" type="video/mp4"></source>
		</video>
		<div class="ed-container full position-fixed background-black-transparent" style="padding: 7px 0;z-index:100">
			<div class="ed-item s-100 m-50 text-center">
				<a class="anchor" href="#main">
					<img src="images/logo.svg" alt="Prometheus" style="width:250px;padding-top: 13px;">	
				</a>
			</div>
			<div class="ed-item s-100 m-50">
				<nav>
					<ul class="nav-bar-container_menu">
						<li class="nav-bar-container_menu-item"><a class="anchor"href="#main">Inicio</a></li>
						<li class="nav-bar-container_menu-item"><a class="anchor"href="#prometheus">Prometheus</a></li>
						<li class="nav-bar-container_menu-item"><a class="anchor"href="#services">Servicios</a></li>
						<li class="nav-bar-container_menu-item"><a class="anchor"href="#portfolio">Portafolio</a></li>
						<li class="nav-bar-container_menu-item"><a class="anchor"href="#contact">Contacto</a></li>
					</ul>
				</nav>
			</div>
		</div>
	</div>
	<div id="prometheus" class="wwa-section">
		<div class="ed-container overflow-hidden">
			<div class="ed-item s-100">
				<h1 class="text-center">
					<span class="top-title font-color-brown">¿Quienes sómos?</span> <br>
					<span class="bottom-title">PROMETHEUS</span>
				</h1>
			</div>
	...
	<div id="services" class="service-section">
			<h1 class="text-center">
			<span class="top-title font-color-brown">SERVICIOS</span>
			<br>
			<span class="bottom-title">LO QUE NOS APASIONA</span>
		</h1>
		<div class="ed-container" style="min-height:440px">
...
Animación 2D | 3D - Cutout - stop motion - whiteBoard - infographics - motion graphics - diseño de personajes - storyboard.
	...
	<div id="portfolio" class="portfolio-section">
		<div class="ed-container">
	       <div class="ed-item s-100"> 
	           <h1 class="text-center">
	           		<span class="top-title font-color-brown">PORTAFOLIO</span>
	           		<br>
				   	<span class="bottom-title">NUESTROS PRODUCTOS</span>
	           </h1>
	       </div>
	       <div class="ed-item s-100">
	       		<div class="text-center portfolio-section__tags">	       
		           <a href="#" class="navigator  active" data-option="0">Todos</a>
		           <a href="#" class="navigator" data-option="1">Videos</a>
		           <a href="#" class="navigator" data-option="2">Animación</a>
		           <a href="#" class="navigator" data-option="3">Fotografia</a>
		        </div>
	       </div>
    	</div>
	    <div id="portfolio-block" class="ed-container no-padding">
	...
	<div id="contact" class="contact-section">
		<div class="ed-container">
			<div class="ed-item s-100 m-50">
				<h1>	
					<span class="top-title font-color-brown">HABLE CON</span> 
					<br>
					<span class="bottom-title">PROMETHEUS FILMS</span>
				</h1>	
				<p class="font-color-gray font-weight-300">
					Déjenos sus datos e inquietudes y nosotros iremos por la antorcha precisa.
					Es hora de contar lo que hacemos de otra manera.
				</p>
			</div>
			<div class="ed-item s-100 m-50">
	...
	<div class="footer-redes">
		<div class="ed-container full">
			<div class="ed-item s-100 text-center">
				<a href="#"><img src="images/rs_youtube.svg" alt="" width="30" height="30"></a>&nbsp;&nbsp;
				<a href="#"><img src="images/rs_vimeo.svg" alt="" width="30" height="30"></a>&nbsp;&nbsp;
				<a href="#"><img src="images/rs_flickr.svg" alt="" width="30" height="30"></a>&nbsp;&nbsp;
				<a href="#"><img src="images/rs_instagram.svg" alt="" width="30" height="30"></a>&nbsp;&nbsp;
				<a href="#"><img src="images/rs_facebook.svg" alt="" width="30" height="30"></a>
			</div>
			<div class="ed-item s-100 text-center" style="padding:1em 0;">
				<a class="copyright">MEDELLÍN, COLOMBIA</a> <span class="copyright">-</span> <a class="copyright">TELÉFONO: 3186435090</a> <span class="copyright">-</span> <a href="#" class="copyright">E-MAIL: MERCADEO@PROMETHEUSFILMS.TV</a> <span class="copyright">-</span> <a href="#" class="copyright">WWWW.PROMETHEUSFILMS.TV</a>
			</div>
		</div>
	</div>
	<div class="veil"></div>
